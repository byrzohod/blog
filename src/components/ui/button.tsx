...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-accent text-white hover:bg-accent-hover hover:shadow-[0_0_20px_hsl(var(--glow-purple)/0.4)]',
        destructive: 'bg-error text-white hover:bg-error/90',
        outline: 'border border-border bg-background hover:bg-background-muted hover:text-foreground hover:border-accent/50',
        ...
        gradient: 'bg-gradient-to-r from-[hsl(var(--gradient-start))] to-[hsl(var(--gradient-end))] text-white hover:shadow-[0_0_25px_hsl(var(--glow-purple)/0.5),0_0_50px_hsl(var(--glow-cyan)/0.3)] hover:scale-[1.02]',
      },
      size: {
