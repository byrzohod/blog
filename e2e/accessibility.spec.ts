...
test.describe('Accessibility', () => {
  ...
  test.describe('Heading Hierarchy', () => {
    ...
    test('should have at least one h1 on about page', async ({ page }) => {
    ...
    test('should have proper heading order (no skipping levels)', async ({ page }) => {
      await page.goto('/');
  ...
  test.describe('Form Labels', () => {
    ...
    test('contact form should have labeled inputs', async ({ page }) => {
    ...
    test('subscribe form should have email input', async ({ page }) => {
      ...
      // Subscribe page uses placeholder for email input
  ...
  test.describe('Focus Visibility', () => {
    test('interactive elements should receive focus on tab', async ({ page }) => {
      await page.goto('/');
